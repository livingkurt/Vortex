			...
			args: [
				{
					...
					max: 16,
					tooltip:
						'Colors used in each set. If 0 or more than the number of colors, all the colors are used.',
					default: 0
				},
				{
					name: 'Skip After',
		...
		},
		{
			...
			args: [
				...
				},
				{
					...
					tooltip:
						'If 0, colors morph smoothly (A to B to C). If 1, colors morph in reverse (B to A then C to B).',
					default: 0
				}
			],
			timings: [
		...
		},
		{
			...
			args: [
				...
				},
				{
					...
					name: 'Direction',
					tooltip:
						'If 0, the wave length increases. If 1, the wave length decreases. If 2, the wave length increases then decreases.',
					default: 2
				},
				{
					min: 0,
		...
		},
		{
			...
			args: [
				...
				},
				{
					...
					name: 'Direction',
					tooltip:
						'If 0, the shift length increases. If 1, the shift length decreases. If 2, the shift length increases then decreases.',
					default: 2
				},
				{
					min: 0,
		...
		},
		{
			...
			timings: [
				...
				},
				{
					name: 'A Blank',
					tooltip:
						'Length blank is shown between strobes in first pattern. If repeat A is 1, this is not shown.',
					default: 25
				},
				{
					name: 'B Strobe',
				...
				},
				{
					name: 'B Blank',
					tooltip:
						'Length blank is shown between strobes in second pattern. If repeat B is 1, this is not shown.',
					default: 40
				},
				{
					name: 'C Strobe',
				...
				},
				{
					name: 'C Blank',
					tooltip:
						'Length blank is shown between strobes in third pattern. If repeat C is 1, this is not shown.',
					default: 47
				},
				{
					name: 'Gap',
